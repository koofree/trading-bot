...
class VLLMProvider(LLMProvider):
    ...
    def __init__(self, model: str, base_url: str = "http://localhost:8000", api_key: Optional[str] = None):
        self.model = model
        self.base_url = base_url.rstrip('/')
    ...
    def get_provider_info(provider_type: str) -> Dict:
        ...
        info = {
            ...
            'ollama': {
                ...
                'example_models': ['llama2', 'mistral', 'codellama', 'neural-chat', 'starling-lm']
            },
            'localai': {
                'name': 'LocalAI',
            ...
            'vllm': {
                ...
                'example_models': ['meta-llama/Llama-2-7b-chat-hf', 'mistralai/Mistral-7B-Instruct-v0.1', 'NousResearch/Meta-Llama-3-8B-Instruct']
            },
            'mock': {
                'name': 'Mock Provider',
