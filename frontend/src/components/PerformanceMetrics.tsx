...
const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <div
      className={`p-5 rounded-xl border ${colorClasses[color]} hover:shadow-md transition-all cursor-pointer hover:-translate-y-0.5`}
    >
      <div className="flex items-center justify-between">
        ...
        <div
          className={`w-12 h-12 rounded-xl flex items-center justify-center ${iconBgClasses[color]}`}
        >
          {icon}
        </div>
      </div>
