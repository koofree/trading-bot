          ...
          <div className="mt-6 flex flex-wrap gap-6">
            <div>
              ...
              <p className={`text-xl font-semibold ${
                (performance.risk_metrics?.daily_pnl ?? 0) >= 0 ? 'text-green-600' : 'text-red-600'
              }`}>
        ...
        <div className="mt-6">
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tabValue === 0 && openPositions.map((position: Position) => (
              ...
              {tabValue === 1 && closedPositions.map((position: Position) => (
                <div key={position.position_id}>
                    ...
                    <div className="p-8 text-center">
                      <div className="text-gray-400 mb-2">
                        <svg className="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 7a2 2 0 002-2h10a2 2 0 002 2v2a2 2 0 00-2 2" />
                        </svg>
                      </div>
